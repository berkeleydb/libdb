...
__env_cachesize_reply *__db_env_cachesize_4000  __P((__env_cachesize_msg *));
__env_close_reply *__db_env_close_4000 __P((__env_close_msg *));
__env_create_reply *__db_env_create_4000 __P((__env_create_msg *));
__env_flags_reply *__db_env_flags_4000 __P((__env_flags_msg *));
__env_open_reply *__db_env_open_4000 __P((__env_open_msg *));
__env_remove_reply *__db_env_remove_4000 __P((__env_remove_msg *));
__txn_abort_reply *__db_txn_abort_4000 __P((__txn_abort_msg *));
__txn_begin_reply *__db_txn_begin_4000 __P((__txn_begin_msg *));
__txn_commit_reply *__db_txn_commit_4000 __P((__txn_commit_msg *));
__txn_discard_reply *__db_txn_discard_4000  __P((__txn_discard_msg *));
__txn_prepare_reply *__db_txn_prepare_4000  __P((__txn_prepare_msg *));
__txn_recover_reply *__db_txn_recover_4000  __P((__txn_recover_msg *));
__db_associate_reply *__db_db_associate_4000  __P((__db_associate_msg *));
__db_bt_maxkey_reply *__db_db_bt_maxkey_4000  __P((__db_bt_maxkey_msg *));
__db_bt_minkey_reply *__db_db_bt_minkey_4000  __P((__db_bt_minkey_msg *));
__db_close_reply *__db_db_close_4000 __P((__db_close_msg *));
__db_create_reply *__db_db_create_4000 __P((__db_create_msg *));
__db_del_reply *__db_db_del_4000 __P((__db_del_msg *));
__db_extentsize_reply *__db_db_extentsize_4000  __P((__db_extentsize_msg *));
__db_flags_reply *__db_db_flags_4000 __P((__db_flags_msg *));
__db_get_reply *__db_db_get_4000 __P((__db_get_msg *));
__db_h_ffactor_reply *__db_db_h_ffactor_4000  __P((__db_h_ffactor_msg *));
__db_h_nelem_reply *__db_db_h_nelem_4000 __P((__db_h_nelem_msg *));
__db_key_range_reply *__db_db_key_range_4000  __P((__db_key_range_msg *));
__db_lorder_reply *__db_db_lorder_4000 __P((__db_lorder_msg *));
__db_open_reply *__db_db_open_4000 __P((__db_open_msg *));
__db_pagesize_reply *__db_db_pagesize_4000  __P((__db_pagesize_msg *));
__db_pget_reply *__db_db_pget_4000 __P((__db_pget_msg *));
__db_put_reply *__db_db_put_4000 __P((__db_put_msg *));
__db_re_delim_reply *__db_db_re_delim_4000  __P((__db_re_delim_msg *));
__db_re_len_reply *__db_db_re_len_4000 __P((__db_re_len_msg *));
__db_re_pad_reply *__db_db_re_pad_4000 __P((__db_re_pad_msg *));
__db_remove_reply *__db_db_remove_4000 __P((__db_remove_msg *));
__db_rename_reply *__db_db_rename_4000 __P((__db_rename_msg *));
__db_stat_reply *__db_db_stat_4000 __P((__db_stat_msg *));
__db_sync_reply *__db_db_sync_4000 __P((__db_sync_msg *));
__db_truncate_reply *__db_db_truncate_4000  __P((__db_truncate_msg *));
__db_cursor_reply *__db_db_cursor_4000 __P((__db_cursor_msg *));
__db_join_reply *__db_db_join_4000 __P((__db_join_msg *));
__dbc_close_reply *__db_dbc_close_4000 __P((__dbc_close_msg *));
__dbc_count_reply *__db_dbc_count_4000 __P((__dbc_count_msg *));
__dbc_del_reply *__db_dbc_del_4000 __P((__dbc_del_msg *));
__dbc_dup_reply *__db_dbc_dup_4000 __P((__dbc_dup_msg *));
__dbc_get_reply *__db_dbc_get_4000 __P((__dbc_get_msg *));
__dbc_pget_reply *__db_dbc_pget_4000 __P((__dbc_pget_msg *));
__dbc_put_reply *__db_dbc_put_4000 __P((__dbc_put_msg *));
#if defined(__cplusplus)
}
#endif
