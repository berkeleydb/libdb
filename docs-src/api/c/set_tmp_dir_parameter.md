...
The syntax of the entry in the <a href="../../guides/programmer_reference/env_db_config.md#env_db_config.DB_CONFIG" class="olink">DB_CONFIG</a> file with the string `set_tmp_dir`, one or more whitespace characters, and the directory name.
