...
source: docs/gsg_txn/CXX/filemanagement.html
---
...
For configuration information, see the <a href="http://download.oracle.com/docs/cd/E17076_02/html/api_reference/CXX/txncheckpoint.html" class="ulink" target="_top">DbEnv::txn_checkpoint() API reference page.</a>
