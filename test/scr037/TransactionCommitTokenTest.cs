...
{
    [TestFixture]
    public class TransactionCommitTokenTest
    {
        static uint masterPort = 8000;
        static uint clientPort = 9000;
        ...
        public void TestCommitSuccess()
        {
            ...
            DatabaseEnvironment master = SetUpEnv("./master", 100, masterPort, true);
            DatabaseEnvironment client = SetUpEnv("./client", 0, clientPort, false);
