---
title: "DB_ENV->log_archive()"
api-name: "DB_ENV->log_archive()"
source: docs/api_reference/C/logarchive.html
---
## DB_ENV-\>log_archive()
...
See <a href="db_archive.md" class="link" title="db_archive">db_archive</a> for more information on database archival procedures.

The `DB_ENV->log_archive()` method is the underlying method used by the <a href="db_archive.md" class="link" title="db_archive">db_archive</a> utility. See the <a href="db_archive.md" class="link" title="db_archive">db_archive</a> utility source code for an example of using `DB_ENV->log_archive()` in a IEEE/ANSI Std 1003.1 (POSIX) environment.
