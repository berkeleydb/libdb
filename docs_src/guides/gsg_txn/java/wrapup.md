...
source: docs/gsg_txn/JAVA/wrapup.html
---
...
<span class="sect1"> [Base API Transaction Example](txnexample_java.md) </span>
...
<span class="sect1"> [DPL Transaction Example](txnexample_dpl.md) </span>
...
<span class="sect1"> [Base API In-Memory Transaction Example](inmem_txnexample_java.md) </span>
...
6.  On application shutdown:
    ...
    3.  Close your databases or store.
