...
# ADD LINK32 /nologo /base:0x13000000 /subsystem:windows /dll /machine:I386 /out:"Release_VC4/libdb.dll"
LINK32_FLAGS=/nologo /base:0x13000000 /subsystem:windows /dll /incremental:no\
 /pdb:"$(OUTDIR)/libdb.pdb" /machine:I386 /def:".\libdb.def"\
 /out:"$(OUTDIR)/libdb.dll" /implib:"$(OUTDIR)/libdb.lib" 
DEF_FILE= \
	".\libdb.def"
LINK32_OBJS= \
...
# ADD LINK32 /nologo /base:0x13000000 /subsystem:windows /dll /debug /machine:I386 /out:"Debug_VC4/libdb.dll"
LINK32_FLAGS=/nologo /base:0x13000000 /subsystem:windows /dll /incremental:yes\
 /pdb:"$(OUTDIR)/libdb.pdb" /debug /machine:I386 /def:".\libdb.def"\
 /out:"$(OUTDIR)/libdb.dll" /implib:"$(OUTDIR)/libdb.lib" 
DEF_FILE= \
	".\libdb.def"
LINK32_OBJS= \
...
"$(INTDIR)\db.obj" : $(SOURCE) $(DEP_CPP_DB_C38) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\hash.obj" : $(SOURCE) $(DEP_CPP_HASH_C5a) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\lock.obj" : $(SOURCE) $(DEP_CPP_LOCK_C62) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\log.obj" : $(SOURCE) $(DEP_CPP_LOG_C74) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
