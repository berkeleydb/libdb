...
public interface DbConstants
{
    ...
    int DB_BEFORE = 3;
    int DB_BTREE = 1;
    int DB_CDB_ALLDB = 0x00002000;
    int DB_CHKSUM = 0x00002000;
    int DB_CONSUME = 5;
    ...
    int DB_DIRECT_DB = 0x00004000;
    int DB_DIRECT_LOG = 0x00008000;
    int DB_DONOTINDEX = -30998;
    int DB_DSYNC_DB = 0x00010000;
    int DB_DSYNC_LOG = 0x00020000;
    int DB_DUP = 0x00004000;
    int DB_DUPSORT = 0x00008000;
    int DB_EID_BROADCAST = -1;
    int DB_EID_INVALID = -2;
    int DB_ENCRYPT = 0x00010000;
    int DB_ENCRYPT_AES = 0x0000001;
    int DB_EXCL = 0x0002000;
    int DB_FAST_STAT = 8;
    int DB_FIRST = 9;
    int DB_FLUSH = 0x001;
    int DB_FORCE = 0x0000004;
    int DB_FREELIST_ONLY = 0x00002000;
    int DB_FREE_SPACE = 0x00004000;
    int DB_GET_BOTH = 10;
    int DB_GET_BOTH_RANGE = 12;
    int DB_GET_RECNO = 13;
    int DB_HASH = 2;
    int DB_IMMUTABLE_KEY = 0x0002000;
    int DB_INIT_CDB = 0x0002000;
    int DB_INIT_LOCK = 0x0004000;
    int DB_INIT_LOG = 0x0008000;
    int DB_INIT_MPOOL = 0x0010000;
    int DB_INIT_REP = 0x0020000;
    int DB_INIT_TXN = 0x0040000;
    int DB_INORDER = 0x00020000;
    int DB_JOINENV = 0x0;
    int DB_JOIN_ITEM = 14;
    ...
    int DB_LOG_AUTOREMOVE = 0x00040000;
    int DB_LOG_INMEMORY = 0x00080000;
    ...
    int DB_READ_COMMITTED = 0x02000000;
    int DB_READ_UNCOMMITTED = 0x04000000;
    int DB_RECNO = 3;
    int DB_RECNUM = 0x00040000;
    int DB_RECOVER = 0x0000020;
    int DB_RECOVER_FATAL = 0x0200000;
    int DB_REGION_INIT = 0x08000000;
    int DB_REGISTER = 0x0400000;
    int DB_RENUMBER = 0x00080000;
    ...
    int DB_REP_STARTUPDONE = -30976;
    int DB_REVSPLITOFF = 0x00100000;
    ...
    int DB_SNAPSHOT = 0x00200000;
    int DB_STAT_CLEAR = 0x0000002;
    int DB_SYSTEM_MEM = 0x0800000;
    int DB_THREAD = 0x0000040;
    int DB_TIME_NOTGRANTED = 0x10000000;
    ...
    int DB_TXN_NOWAIT = 0x0002000;
    int DB_TXN_PRINT = 7;
    int DB_TXN_SYNC = 0x0004000;
    int DB_TXN_WRITE_NOSYNC = 0x0000400;
    int DB_UNKNOWN = 5;
    int DB_UPGRADE = 0x0000001;
    int DB_USE_ENVIRON = 0x0000800;
    int DB_USE_ENVIRON_ROOT = 0x0001000;
