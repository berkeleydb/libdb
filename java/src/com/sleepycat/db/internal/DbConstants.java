...
public interface DbConstants
{
    ...
    int DB_BEFORE = 3;
    int DB_BTREE = 1;
    int DB_CDB_ALLDB = 0x00000004;
    int DB_CHKSUM = 0x00000004;
    int DB_CONSUME = 4;
    ...
    int DB_DIRECT_DB = 0x00000040;
    int DB_DSYNC_DB = 0x00000080;
    int DB_DUP = 0x00000008;
    ...
    int DB_INIT_CDB = 0x00000020;
    int DB_INIT_LOCK = 0x00000040;
    int DB_INIT_LOG = 0x00000080;
    int DB_INIT_MPOOL = 0x00000100;
    int DB_INIT_REP = 0x00000200;
    int DB_INIT_TXN = 0x00000400;
    int DB_INORDER = 0x00000010;
    int DB_JOINENV = 0x0;
    int DB_JOIN_ITEM = 12;
    ...
    int DB_PRIVATE = 0x00001000;
    int DB_QUEUE = 4;
    int DB_RDONLY = 0x00000080;
    int DB_READ_COMMITTED = 0x00000400;
    int DB_READ_UNCOMMITTED = 0x00000200;
    int DB_RECNO = 3;
    int DB_RECNUM = 0x00000020;
    int DB_RECOVER = 0x00000010;
    int DB_RECOVER_FATAL = 0x00002000;
    int DB_REGION_INIT = 0x00004000;
    int DB_REGISTER = 0x00004000;
    int DB_RENUMBER = 0x00000040;
    ...
    int DB_REP_CONF_LEASE = 0x00000008;
    int DB_REP_CONF_NOAUTOINIT = 0x00000010;
    int DB_REP_CONF_NOWAIT = 0x00000020;
    ...
    int DB_REVSPLITOFF = 0x00000080;
    int DB_RMW = 0x00000800;
