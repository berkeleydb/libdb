...
AC_ARG_ENABLE(smallbuild,
	[AS_HELP_STRING([--enable-smallbuild],
...
AC_ARG_ENABLE(atomicsupport,
	AS_HELP_STRING([--disable-atomicsupport],
...
AC_ARG_ENABLE(mutexsupport,
	AS_HELP_STRING([--disable-mutexsupport],
...
AC_ARG_ENABLE(log_checksum,
	AS_HELP_STRING([--disable-log_checksum],
...
AC_ARG_ENABLE(partition,
	AS_HELP_STRING([--disable-partition],
...
AC_ARG_ENABLE(compat185,
	[AS_HELP_STRING([--enable-compat185],
...
AC_ARG_ENABLE(debug_rop,
	[AS_HELP_STRING([--enable-debug_rop],
...
AC_ARG_ENABLE(debug_wop,
	[AS_HELP_STRING([--enable-debug_wop],
...
AC_ARG_ENABLE(o_direct,
	[AS_HELP_STRING([--enable-o_direct],
...
AC_ARG_ENABLE(sql_compat,
	[AS_HELP_STRING([--enable-sql_compat],
...
AC_ARG_ENABLE(amalgamation,
	AS_HELP_STRING([--enable-amalgamation],
...
AC_ARG_ENABLE(sql_codegen,
	[AS_HELP_STRING([--enable-sql_codegen],
...
AC_ARG_ENABLE(localization,
	[AS_HELP_STRING([--enable-localization],
...
AC_ARG_ENABLE(stripped_messages,
	[AS_HELP_STRING([--enable-stripped_messages],
...
AC_ARG_ENABLE(perfmon_statistics,
	[AS_HELP_STRING([--enable-perfmon-statistics],
...
AC_ARG_ENABLE(uimutexes,
	[AS_HELP_STRING([--enable-uimutexes],
...
AC_ARG_ENABLE(atomicfileread,
	[AS_HELP_STRING([--enable-atomicfileread],
...
AC_ARG_WITH([cryptography],
	AS_HELP_STRING([--with-cryptography=yes|no|ipp], [Build database cryptography support @<:@default=yes@:>@.]),
...
AC_ARG_WITH(mutex,
	[AS_HELP_STRING([--with-mutex=MUTEX],
...
AC_ARG_WITH(mutexalign,
	[AS_HELP_STRING([--with-mutexalign=ALIGNMENT],
...
AC_ARG_WITH(stacksize,
	[AS_HELP_STRING([--with-stacksize=SIZE],
...
AC_ARG_WITH(uniquename,
	[AS_HELP_STRING([--with-uniquename=NAME],
...
AC_MSG_CHECKING(if --enable-compile-commands option specified)
AC_ARG_ENABLE(compile-commands,
	[AS_HELP_STRING([--enable-compile-commands],
			[Generate compile_commands.json for LSP support.])],
	[db_cv_compile_commands="$enable_compile_commands"],
	[db_cv_compile_commands="no"])
AC_MSG_RESULT($db_cv_compile_commands)
