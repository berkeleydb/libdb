...
int __dbcl_set_tx_recover __P((DB_ENV *, int (*)(DB_ENV *, DBT *, DB_LSN *, db_recops, void *)));
...
int __dbcl_db_bt_compare __P((DB *, int (*)(const DBT *, const DBT *)));
int __dbcl_db_bt_maxkey __P((DB *, u_int32_t));
int __dbcl_db_bt_minkey __P((DB *, u_int32_t));
int __dbcl_db_bt_prefix __P((DB *, size_t(*)(const DBT *, const DBT *)));
...
int __dbcl_db_h_hash __P((DB *, u_int32_t(*)(const void *, u_int32_t)));
