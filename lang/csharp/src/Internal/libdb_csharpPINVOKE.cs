...
class libdb_csharpPINVOKE {
  ...
  [DllImport(libname, EntryPoint="CSharp_DB_ENV_repmgr_get_local_site")]
  public static extern int DB_ENV_repmgr_get_local_site(HandleRef jarg1, out IntPtr jarg2, ref uint jarg3);
