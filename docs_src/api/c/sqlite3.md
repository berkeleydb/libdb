...
title: "sqlite3"
api-name: "sqlite3"
source: docs/api_reference/C/sqlite3.html
---
## sqlite3
...
For more information on building this tool, see the <a href="../../guides/installation/build_unix.md#build_unix_intro" class="olink">"Building for UNIX/POSIX"</a>

For more information on how to use Sqlite3 see the <a href="http://www.sqlite.org/sqlite.html" class="ulink" target="_top">SQLite Documentation page.</a>
