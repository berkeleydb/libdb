...
The priority of this database environment in the replication group. The priority must be a non-zero integer, or 0 if this environment cannot be a replication group master. (See <a href="../../programmer_reference/rep_pri.html" class="olink">Replication environment priorities</a> for more information).
