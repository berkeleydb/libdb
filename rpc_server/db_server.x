...
program DB_SERVERPROG {
	version DB_SERVERVERS {
		...
		__env_open_reply __DB_env_open(__env_open_msg) = 4;
		__env_remove_reply __DB_env_remove(__env_remove_msg) = 5;
		__txn_abort_reply __DB_txn_abort(__txn_abort_msg) = 6;
		__txn_begin_reply __DB_txn_begin(__txn_begin_msg) = 7;
		__txn_commit_reply __DB_txn_commit(__txn_commit_msg) = 8;
		__db_bt_maxkey_reply __DB_db_bt_maxkey(__db_bt_maxkey_msg) = 9;
		__db_bt_minkey_reply __DB_db_bt_minkey(__db_bt_minkey_msg) = 10;
		__db_close_reply __DB_db_close(__db_close_msg) = 11;
		__db_create_reply __DB_db_create(__db_create_msg) = 12;
		__db_del_reply __DB_db_del(__db_del_msg) = 13;
		__db_flags_reply __DB_db_flags(__db_flags_msg) = 14;
		__db_get_reply __DB_db_get(__db_get_msg) = 15;
		__db_h_ffactor_reply __DB_db_h_ffactor(__db_h_ffactor_msg) = 16;
		__db_h_nelem_reply __DB_db_h_nelem(__db_h_nelem_msg) = 17;
		__db_key_range_reply __DB_db_key_range(__db_key_range_msg) = 18;
		__db_lorder_reply __DB_db_lorder(__db_lorder_msg) = 19;
		__db_open_reply __DB_db_open(__db_open_msg) = 20;
		__db_pagesize_reply __DB_db_pagesize(__db_pagesize_msg) = 21;
		__db_put_reply __DB_db_put(__db_put_msg) = 22;
		__db_re_delim_reply __DB_db_re_delim(__db_re_delim_msg) = 23;
		__db_re_len_reply __DB_db_re_len(__db_re_len_msg) = 24;
		__db_re_pad_reply __DB_db_re_pad(__db_re_pad_msg) = 25;
		__db_remove_reply __DB_db_remove(__db_remove_msg) = 26;
		__db_rename_reply __DB_db_rename(__db_rename_msg) = 27;
		__db_stat_reply __DB_db_stat(__db_stat_msg) = 28;
		__db_swapped_reply __DB_db_swapped(__db_swapped_msg) = 29;
		__db_sync_reply __DB_db_sync(__db_sync_msg) = 30;
		__db_cursor_reply __DB_db_cursor(__db_cursor_msg) = 31;
		__db_join_reply __DB_db_join(__db_join_msg) = 32;
		__dbc_close_reply __DB_dbc_close(__dbc_close_msg) = 33;
		__dbc_count_reply __DB_dbc_count(__dbc_count_msg) = 34;
		__dbc_del_reply __DB_dbc_del(__dbc_del_msg) = 35;
		__dbc_dup_reply __DB_dbc_dup(__dbc_dup_msg) = 36;
		__dbc_get_reply __DB_dbc_get(__dbc_get_msg) = 37;
		__dbc_put_reply __DB_dbc_put(__dbc_put_msg) = 38;
	} = 1;
} = 351457;
