...
public interface DbConstants
{
    ...
    int DB_RECOVER_FATAL = 0x00008000;
    int DB_REGION_INIT = 0x00020000;
    int DB_REGISTER = 0x00010000;
    ...
    int DB_REP_CONF_BULK = 0x00000008;
    int DB_REP_CONF_DELAYCLIENT = 0x00000010;
    int DB_REP_CONF_INMEM = 0x00000020;
    int DB_REP_CONF_LEASE = 0x00000040;
    int DB_REP_CONF_NOWAIT = 0x00000080;
    ...
    int DB_REP_IGNORE = -30981;
    int DB_REP_ISPERM = -30980;
    int DB_REP_LEASE_TIMEOUT = 9;
    int DB_REP_MASTER = 0x00000002;
    int DB_REP_NEWSITE = -30976;
    int DB_REP_NOBUFFER = 0x00000002;
    int DB_REP_NOTPERM = -30975;
    ...
    int DB_VERB_REP_SYSTEM = 0x00002000;
    int DB_VERB_REP_TEST = 0x00004000;
    int DB_VERB_WAITSFOR = 0x00008000;
