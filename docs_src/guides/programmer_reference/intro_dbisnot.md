...
api-name: "What Berkeley DB is not"
source: docs/programmer_reference/intro_dbisnot.html
---
...
Records in Berkeley DB are (<span class="emphasis">*key*</span>, <span class="emphasis">*value*</span>) pairs. Berkeley DB supports only a few logical operations on records. They are:
