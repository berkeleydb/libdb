...
static void
db_rpc_serverprog_4000(rqstp, transp)
	struct svc_req *rqstp;
	register SVCXPRT *transp;
{
	union {
		__env_cachesize_msg __db_env_cachesize_4000_arg;
		__env_close_msg __db_env_close_4000_arg;
		__env_create_msg __db_env_create_4000_arg;
		__env_flags_msg __db_env_flags_4000_arg;
		__env_open_msg __db_env_open_4000_arg;
		__env_remove_msg __db_env_remove_4000_arg;
		__txn_abort_msg __db_txn_abort_4000_arg;
		__txn_begin_msg __db_txn_begin_4000_arg;
		__txn_commit_msg __db_txn_commit_4000_arg;
		__txn_discard_msg __db_txn_discard_4000_arg;
		__txn_prepare_msg __db_txn_prepare_4000_arg;
		__txn_recover_msg __db_txn_recover_4000_arg;
		__db_associate_msg __db_db_associate_4000_arg;
		__db_bt_maxkey_msg __db_db_bt_maxkey_4000_arg;
		__db_bt_minkey_msg __db_db_bt_minkey_4000_arg;
		__db_close_msg __db_db_close_4000_arg;
		__db_create_msg __db_db_create_4000_arg;
		__db_del_msg __db_db_del_4000_arg;
		__db_extentsize_msg __db_db_extentsize_4000_arg;
		__db_flags_msg __db_db_flags_4000_arg;
		__db_get_msg __db_db_get_4000_arg;
		__db_h_ffactor_msg __db_db_h_ffactor_4000_arg;
		__db_h_nelem_msg __db_db_h_nelem_4000_arg;
		__db_key_range_msg __db_db_key_range_4000_arg;
		__db_lorder_msg __db_db_lorder_4000_arg;
		__db_open_msg __db_db_open_4000_arg;
		__db_pagesize_msg __db_db_pagesize_4000_arg;
		__db_pget_msg __db_db_pget_4000_arg;
		__db_put_msg __db_db_put_4000_arg;
		__db_re_delim_msg __db_db_re_delim_4000_arg;
		__db_re_len_msg __db_db_re_len_4000_arg;
		__db_re_pad_msg __db_db_re_pad_4000_arg;
		__db_remove_msg __db_db_remove_4000_arg;
		__db_rename_msg __db_db_rename_4000_arg;
		__db_stat_msg __db_db_stat_4000_arg;
		__db_sync_msg __db_db_sync_4000_arg;
		__db_truncate_msg __db_db_truncate_4000_arg;
		__db_cursor_msg __db_db_cursor_4000_arg;
		__db_join_msg __db_db_join_4000_arg;
		__dbc_close_msg __db_dbc_close_4000_arg;
		__dbc_count_msg __db_dbc_count_4000_arg;
		__dbc_del_msg __db_dbc_del_4000_arg;
		__dbc_dup_msg __db_dbc_dup_4000_arg;
		__dbc_get_msg __db_dbc_get_4000_arg;
		__dbc_pget_msg __db_dbc_pget_4000_arg;
		__dbc_put_msg __db_dbc_put_4000_arg;
	} argument;
	char *result;
...
void __dbsrv_main()
{
	...
	if (!svc_register(transp, DB_RPC_SERVERPROG, DB_RPC_SERVERVERS, db_rpc_serverprog_4000, IPPROTO_TCP)) {
