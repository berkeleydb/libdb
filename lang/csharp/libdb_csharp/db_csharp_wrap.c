...
SWIGINTERN int DB_ENV_repmgr_get_local_site(DB_ENV *self,char const **host,u_int *port){
...
SWIGEXPORT int SWIGSTDCALL CSharp_DB_ENV_repmgr_get_local_site(void * jarg1, void * jarg2, void * jarg3) {
  int jresult ;
  DB_ENV *arg1 = (DB_ENV *) 0 ;
  char **arg2 = (char **) 0 ;
  u_int *arg3 = (u_int *) 0 ;
  ...
  arg2 = (char **)jarg2; 
  arg3 = (u_int *)jarg3; 
  result = (int)DB_ENV_repmgr_get_local_site(arg1,(char const **)arg2,arg3);
  jresult = result; 
  return jresult;
}
