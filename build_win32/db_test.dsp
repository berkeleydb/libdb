...
# ADD LINK32 Release/libdb31.lib /nologo /subsystem:console /machine:I386
...
# ADD LINK32 Debug/libdb31d.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /pdb:none /debug /machine:I386 /out:"Debug/dbkill.exe" /fixed:no
# Begin Special Build Tool
SOURCE=$(InputPath)
PostBuild_Desc=Copy built executable files.
