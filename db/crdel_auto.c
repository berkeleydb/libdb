 ...
 */
int
__crdel_inmem_create_log(dbenv, txnid, ret_lsnp, flags,
 ...
 */
int
__crdel_inmem_rename_log(dbenv, txnid, ret_lsnp, flags,
    oldname, newname, fid)
	DB_ENV *dbenv;
	DB_TXN *txnid;
	DB_LSN *ret_lsnp;
 ...
 */
int
__crdel_inmem_remove_log(dbenv, txnid, ret_lsnp, flags,
    name, fid)
	DB_ENV *dbenv;
	DB_TXN *txnid;
	DB_LSN *ret_lsnp;
