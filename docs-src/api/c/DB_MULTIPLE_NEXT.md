...
Returns the next <a href="dbt.md" class="link" title="Chapter 4.  The DBT Handle">DBT</a> in the bulk retrieval set.
...
The **data** parameter is a <a href="dbt.md" class="link" title="Chapter 4.  The DBT Handle">DBT</a> structure returned from a successful call to <a href="dbget.md" class="xref" title="DB-&gt;get()">DB-&gt;get()</a> or <a href="dbcget.md" class="xref" title="DBcursor-&gt;get()">DBcursor-&gt;get()</a> for which he <a href="dbcget.md#dbcget_DB_MULTIPLE" class="link">DB_MULTIPLE</a> flag was specified.
