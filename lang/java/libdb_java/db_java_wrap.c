...
SWIGINTERN struct __db_repmgr_localsite DbEnv_repmgr_get_local_site(struct DbEnv *self){
...
SWIGEXPORT jobjectArray JNICALL Java_com_sleepycat_db_internal_db_1javaJNI_Db_1get_1partition_1dirs(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  {
    if (result != NULL) {
      /*@SWIG:../lang/java/libdb_java/java_typemaps.i,441,STRING_ARRAY_OUT@*/	int i, len;
...
SWIGEXPORT jobject JNICALL Java_com_sleepycat_db_internal_db_1javaJNI_DbEnv_1repmgr_1get_1local_1site(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jobject jresult = 0 ;
  struct DbEnv *arg1 = (struct DbEnv *) 0 ;
  struct __db_repmgr_localsite result;
  ...
  errno = 0;
  result = DbEnv_repmgr_get_local_site(arg1);
  if (!DB_RETOK_STD(errno)) {
    __dbj_throw(jenv, errno, NULL, NULL, JDBENV);
  }
  
  {
    jstring addr_host;
    if ((&result)->host == NULL)
    return 0; /* Local site was not set. */
